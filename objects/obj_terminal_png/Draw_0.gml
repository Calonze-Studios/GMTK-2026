...
if _tree_ext == ".png"
{
	...
	if global.puzzle_progress == 1 && !treesolved //to avoid sequencebreaks
	{
		treesolved = true
		global.puzzle_progress[1] = 2
	}
	if global.puzzle_progress == 2 //to avoid sequencebreaks
	{
		treesolved = true
...
if file_exists(_note2)
{
	...
	draw_sprite(spr_stickynote2,0,global.cam_x+255+80,100)
}
