...
-- CONTROLS
You can go left and right with the arrow keys or WASD.
You can interact with things with the UP arrow key (W).
You can go forwards through dialogue with UP (W) and skip through it really fast with DOWN (S).
There's gamepad controls, technically, but you'll also need to use the keyboard a lot, so it's kind of just a formality...
